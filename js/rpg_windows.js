...
Window_Base._faceWidth  = 180;
Window_Base._faceHeight = 180;
...
Window_Base.prototype.drawFace = function(faceName, faceIndex, x, y, width, height) {
    ...
    var sw = 180;//Math.min(180, pw);
    var sh = 180;//Math.min(180, ph);
...
Window_Base.prototype.drawActorFace = function(actor, x, y, width, height) {
    this.drawFace(actor.faceName(), actor.faceIndex(), x, y, 180, 180); 
};
...
Window_Message.prototype.drawMessageFace = function() {
    this.drawFace($gameMessage.faceName(), $gameMessage.faceIndex(), 0, 0, 180, 180);
    ImageManager.releaseReservation(this._imageReservationId);
};

Window_Message.prototype.newLineX = function() {
    return $gameMessage.faceName() === '' ? 0 : 204;
};
...
Window_MapName.prototype.initialize = function() {
    ...
    var height = this.windowHeight();
    Window_Base.prototype.initialize.call(this, 860, 20, wight, height); //改变名称显示位置
    this.opacity = 0;
